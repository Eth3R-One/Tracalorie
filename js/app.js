class CalorieTracker {
  ...
  setLimit(caloreLimit) {
    this._calorieLimit = caloreLimit;
    Storage.setCalorieLimit(caloreLimit);
    this._displayCaloriesLimit();
    this._render();
  }
  ...
  _displayCaloriesTotal() {
    const totalCaloresEl = document.getElementById("calories-total");
    totalCaloresEl.innerHTML = this._totalCalories;
  }
  _displayCaloriesLimit() {
    const totalCaloresEl = document.getElementById("calories-limit");
    totalCaloresEl.innerHTML = this._calorieLimit;
  }
  ...
  //   if (remaining < 0) {
  //     parentEl.classList.remove("bg-white");
  ...
  //     parentEl.classList.add("bg-white");
...
class App {
  ...
  // Handle form
  // Add to meal if its from meal form
  // Add to workout form if its from workout form
  ...
  _newItem(type, e) {
    ...
    // add meal or work according to type to list
    if (type === "meal") {
